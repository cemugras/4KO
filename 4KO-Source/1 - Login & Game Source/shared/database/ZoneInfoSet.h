...
public:
	...
	virtual tstring GetTableName() { return _T("ZONE_INFO_2369"); }
#elif GAME_SOURCE_VERSION  == 1534
	virtual tstring GetTableName() { return _T("ZONE_INFO_1534"); }
#elif GAME_SOURCE_VERSION  == 1098
	virtual tstring GetTableName() { return _T("ZONE_INFO_1098"); }
#endif
