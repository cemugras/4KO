...
bool LoadTextures()
{
    ...
    HRESULT res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\Background.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &LauncherBackgroundTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\Background.png"));
    }
    // Start
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\StartMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &StartButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\StartMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\StartMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &StartButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\StartMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\StartMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &StartButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\StartMouseClick.png"));
    } 
    // HomePage
    /*res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\HomeMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &HomePageButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\HomeMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\HomeMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &HomePageButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\HomeMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\HomeMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &HomePageButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\HomeMouseClick.png"));
    }*/
    // Option
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\OptionsMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &SettingsButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\OptionsMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\OptionsMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &SettingsButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\OptionsMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\OptionsMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &SettingsButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\OptionsMouseClick.png"));
    }
    // Close
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\CloseMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &CloseButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\CloseMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\CloseMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &CloseButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\CloseMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\CloseMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &CloseButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\CloseMouseClick.png"));
    }
    // Discord
    /*res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\DiscordMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &DiscordButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\DiscordMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\DiscordMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &DiscordButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\DiscordMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\DiscordMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &DiscordButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\DiscordMouseClick.png"));
    }*/
    // Forum   
    /*res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\ForumMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &ForumButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\ForumMouseOut.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\ForumMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &ForumButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\ForumMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\ForumMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &ForumButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\ForumMouseClick.png"));
    }*/
    // Facebook
    /*res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\FacebookMouseOut.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &FacebookButtonTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\FacebookMouseOut.png"));
    }  
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\FacebookMouseOver.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &FacebookButtonHoverTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\FacebookMouseOver.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\FacebookMouseClick.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &FacebookButtonDownTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\FacebookMouseClick.png"));
    }*/
    // Progress Bar
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\ProgressEmpty.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &ProgressTexture);
    if (res != D3D_OK) {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\ProgressEmpty.png"));
    }
    res = D3DXCreateTextureFromFileEx(g_pd3dDevice, xorstr("ISTIRAP\\Launcher\\ProgressValue.png"), D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, D3DCOLOR_ARGB(128, 128, 128, 128), 0, 0, &ProgressFillTexture);
    if (res != D3D_OK)
    {
        textureFail = true;
        unloadedResources.push_back(xorstr("ISTIRAP\\Launcher\\ProgressValue.png"));
    }
...
static std::string subnetLisanlar[] = { xorstr("192.168.1.xxx") };
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    std::string dosyalarNerdeLenAmq = xorstr("\\ISTIRAP\\Launcher\\");

    hBMP = (HBITMAP)LoadImage(NULL, (std::string(WP) + dosyalarNerdeLenAmq + xorstr("bg.bmp")).c_str(), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    iW = GetPrivateProfileIntA(xorstr("LAUNCHER"), xorstr("WIDTH"), 802, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    iH = GetPrivateProfileIntA(xorstr("LAUNCHER"), xorstr("HEIGHT"), 594, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());

    int tmpX = 0, tmpY = 0, fontSize = 0, fontWeight;
    char InfoFont[25];
    // BG
    tmpX = GetPrivateProfileIntA(xorstr("BG"), xorstr("X"), 0, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    tmpY = GetPrivateProfileIntA(xorstr("BG"), xorstr("Y"), 0, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    LauncherBackgorundPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Start Button
    tmpX = GetPrivateProfileIntA(xorstr("START_BUTTON"), xorstr("X"), 608, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    tmpY = GetPrivateProfileIntA(xorstr("START_BUTTON"), xorstr("Y"), 509, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    StartButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Homepage Button
    //tmpX = GetPrivateProfileIntA(xorstr("HOMEPAGE_BUTTON"), xorstr("X"), 23, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //tmpY = GetPrivateProfileIntA(xorstr("HOMEPAGE_BUTTON"), xorstr("Y"), 511, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //HomePageButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Settings Button
    tmpX = GetPrivateProfileIntA(xorstr("SETTINGS_BUTTON"), xorstr("X"), 161, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    tmpY = GetPrivateProfileIntA(xorstr("SETTINGS_BUTTON"), xorstr("Y"), 511, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    SettingsButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Close Button
    tmpX = GetPrivateProfileIntA(xorstr("CLOSE_BUTTON"), xorstr("X"), 765, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    tmpY = GetPrivateProfileIntA(xorstr("CLOSE_BUTTON"), xorstr("Y"), 3, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    CloseButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    //Discord Button
    //tmpX = GetPrivateProfileIntA(xorstr("DISCORD_BUTTON"), xorstr("X"), 608, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //tmpY = GetPrivateProfileIntA(xorstr("DISCORD_BUTTON"), xorstr("Y"), 509, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //DiscordButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Forum Button
    //tmpX = GetPrivateProfileIntA(xorstr("FORUM_BUTTON"), xorstr("X"), 161, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //tmpY = GetPrivateProfileIntA(xorstr("FORUM_BUTTON"), xorstr("Y"), 511, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //ForumButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Facebook Button
    //tmpX = GetPrivateProfileIntA(xorstr("FACEBOOK_BUTTON"), xorstr("X"), 161, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //tmpY = GetPrivateProfileIntA(xorstr("FACEBOOK_BUTTON"), xorstr("Y"), 511, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    //FacebookButtonPosition = D3DXVECTOR3(tmpX, tmpY, 0);
     // Progressbar
    tmpX = GetPrivateProfileIntA(xorstr("PROGRESSBAR"), xorstr("X"), 24, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    tmpY = GetPrivateProfileIntA(xorstr("PROGRESSBAR"), xorstr("Y"), 557, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    ProgressPosition = D3DXVECTOR3(tmpX, tmpY, 0);
    // Font
    fontSize = GetPrivateProfileIntA(xorstr("FONT"), xorstr("FONT_SIZE"), 14, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    fontWeight = GetPrivateProfileIntA(xorstr("FONT"), xorstr("FONT_WEIGHT"), 500, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    GetPrivateProfileStringA(xorstr("FONT"), xorstr("FAMILY"), "Verdana", InfoFont, 25, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    // Info Text
    TextStateBaseX = GetPrivateProfileIntA(xorstr("INFO_TEXT"), xorstr("X"), 578, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    TextStatePos.top = GetPrivateProfileIntA(xorstr("INFO_TEXT"), xorstr("Y"), 530, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    // Page Text
    TextPagePos.left = GetPrivateProfileIntA(xorstr("PAGE_TEXT"), xorstr("X"), 610, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    TextPagePos.top = GetPrivateProfileIntA(xorstr("PAGE_TEXT"), xorstr("Y"), 430, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    // Notices
    TextNoticePos.left = GetPrivateProfileIntA(xorstr("NOTICES"), xorstr("START_X"), 200, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    TextNoticePos.top = GetPrivateProfileIntA(xorstr("NOTICES"), xorstr("START_Y"), 480, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
    NoticeOffsetY = GetPrivateProfileIntA(xorstr("NOTICES"), xorstr("OFFSET_Y"), 23, (std::string(WP) + dosyalarNerdeLenAmq + xorstr(".UISettings.ini")).c_str());
...
LRESULT CALLBACK WndProc222(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE:
    {
        //std::string Path = std::string(Engine->WorkingPath) + "\\ISTIRAP\\Launcher\\" + "curse_loading.gif";
