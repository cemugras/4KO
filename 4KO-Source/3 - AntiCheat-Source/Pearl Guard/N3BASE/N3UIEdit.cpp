...
#endif
HCURSOR cur = LoadCursorFromFile("Data\\cursor_normal.cur");
...
BOOL CN3UIEdit::CreateEditWindow(HWND hParent, RECT rect)
{
	...
	s_hWndEdit = CreateWindowA("EDIT", "EditWindow", WS_CHILD|WS_TABSTOP|ES_LEFT|ES_WANTRETURN | ES_NOHIDESEL, rect.left, rect.top, rect.right-rect.left, rect.bottom-rect.top, hParent, NULL, NULL, NULL);
...
void CN3UIEdit::UpdateTextFromEditCtrl()
{
	...
	//HCURSOR cur = LoadCursorFromFile("cursor_normal.cur");
	SetCursor(cur);
}
